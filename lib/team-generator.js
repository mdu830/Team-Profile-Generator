...
const baseHtml = require('./lib/basehtml')
const renderer = require("./html/tmp");
// console.log("hello");
...
class TeamGenerator {
    ...
    createManager(data) {
        const html = renderer.generateManager(data);
...
//         fs.readFile("lib/base.html", "utf8", (html) => {
//             html.split("<script>|</script>").join(this.appendEmployee());

//             fs.writeFile('(new)index.html', html, console.log("New Team Profile Generated!"))
//         })
